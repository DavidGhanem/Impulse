...
const tableRows = [
  { price: "$50 / month", keep: "$40.00", earn: "$10.00" },
  { price: "$75 / month", keep: "$60.00", earn: "$15.00" },
  { price: "$100 / month", keep: "$80.00", earn: "$20.00" },
  { price: "$150 / month", keep: "$120.00", earn: "$30.00" },
];
...
export default function Pricing() {
  ...
  const youKeep = total * 0.8;
  const iEarn = total * 0.2;
        ...
        >
          ...
          <div>
                    ...
                    <tr
                      ...
                      onMouseEnter={(e) =>
                        Array.from(e.currentTarget.cells).forEach(
                          (c) => (c.style.background = "rgba(255,90,31,0.04)"),
                        )
                      }
                      onMouseLeave={(e) =>
                        Array.from(e.currentTarget.cells).forEach(
            ...
            >
              ...
              . <strong style={{ fontStyle: "normal" }}>Fair?</strong>
            </p>
          </div>
          ...
          >
            ...
            {[
              ...
              {
                label: "New Members / Month (via site)",
                id: "members",
                min: 1,
                max: 50,
                step: 1,
